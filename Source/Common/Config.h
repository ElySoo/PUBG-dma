...
public:
	...
	static bool Save()
	{
		...
		[&] {
				...
				Config[ConfigName]["Enable"] = GameData.Config.ESP.Enable;//¿ªÆôµÐÈËÍ¸ÊÓ
				...
				Config[ConfigName]["shanghai"] = GameData.Config.ESP.伤害;//ÉËº¦
				...
				Config[ConfigName]["ClanName"] = GameData.Config.ESP.ClanName;//‘ðê 
				...
				Config[ConfigName]["dengji"] = GameData.Config.ESP.等级;//µÈ¼¶
				Config[ConfigName]["guanzhan"] = GameData.Config.ESP.观战;//¹ÛÕ½
				...
				Config[ConfigName]["FontSize"] = GameData.Config.ESP.FontSize;//ÐÅÏ¢´óÐ¡
				Config[ConfigName]["WeaponDistanceMax"] = GameData.Config.ESP.WeaponDistanceMax;//ÎäÆ÷¾àÀë
				Config[ConfigName]["InfoDistanceMax"] = GameData.Config.ESP.InfoDistanceMax;//ÐÅÏ¢¾àÀë

	...
	inline void Render11()
	{
		...
		if (GameData.Config.Window.Players && ImGui::Begin("Menu111", &GameData.Config.Window.Players, ImGuiWindowFlags_NoBackground | ImGuiWindowFlags_NoDecoration | ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize))
		{
			...
			ImGui::BeginChild(false, "Child", "o", ImVec2(1145, 565));
			{
				ImGui::BeginGroup();
				{
					ImGui::BeginChild(true, U8("Player List (Toggle via hotkeys)"), "o", ImVec2(870, 547));
					{
						
						
						static const char* filterPlayerList[] = { U8("All List"), U8("Blacklist"), U8("Whitelist") };
						static int filterPlayerListIndex = 0;


						if (ImGui::BeginCombo(U8("##List Type"), filterPlayerList[filterPlayerListIndex], 0, true))
						{
						...
						static const char* filterPlayerType[] = { U8("All Types"), U8("Player"), U8("Collaborator"), U8("Teammate"), U8("Self"), U8("Bot") };
						static int filterPlayerTypeIndex = 0;
						if (ImGui::BeginCombo(U8("##PlayerType"), filterPlayerType[filterPlayerTypeIndex], 0))
						{
						...
						//ImGui::SameLine(); 
						static const char* items[] = { U8("No Check"), U8("TPPsolo"), U8("TPPsquad"), U8("FPPsolo"), U8("FPPsquad") };
						if (ImGui::BeginCombo(U8("##Rank Data"), items[GameData.Config.PlayerList.RankMode], 0)) {
						...
						if (ImGui::BeginTable(U8("Player List"), 11, flags, ImVec2(880, 440)))
						{
							ImGui::TableSetupScrollFreeze(0, 1);
							ImGui::TableSetupColumn(U8("  Team"), ImGuiTableColumnFlags_WidthFixed | ImGuiTableColumnFlags_DefaultSort, 50.0f);
							ImGui::TableSetupColumn(U8("Player Nickname"), ImGuiTableColumnFlags_WidthFixed, 180.0f);
							ImGui::TableSetupColumn(U8("Rank"), ImGuiTableColumnFlags_WidthFixed, 70.0f);
							ImGui::TableSetupColumn(U8("Score"), ImGuiTableColumnFlags_WidthFixed, 60.f);
							ImGui::TableSetupColumn(U8("K/D"), ImGuiTableColumnFlags_WidthFixed, 60.0f);
							ImGui::TableSetupColumn(U8("Win Rate"), ImGuiTableColumnFlags_WidthFixed, 60.0f);
							ImGui::TableSetupColumn(U8("Kills"), ImGuiTableColumnFlags_WidthFixed, 60.0f);
							ImGui::TableSetupColumn(U8("Damage"), ImGuiTableColumnFlags_WidthFixed, 60.0f);
							ImGui::TableSetupColumn(U8("Level"), ImGuiTableColumnFlags_WidthFixed, 60.0f);
							ImGui::TableSetupColumn(U8("Type"), ImGuiTableColumnFlags_WidthFixed, 60.0f);
							ImGui::TableSetupColumn(U8("List"), ImGuiTableColumnFlags_WidthFixed, 80.0f);
